...
public enum ModArmorMaterials implements ArmorMaterial {
    MELON_CRUST("melon_crust", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.MELON_CRUST.get());
    });
